...
try {
    ...
    if (empty($filtered_products)) {
        $products_html = '<div class="col-12"><p class="text-center text-muted">Aucun produit trouvé pour la catégorie femme avec les filtres appliqués.</p></div>';
    } else {
