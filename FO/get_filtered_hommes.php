...
try {
    ...
    $sql = "SELECT DISTINCT p.id, p.nom, p.prix, p.id_promotion, pr.discount,
    ...
    if (empty($filtered_products)) {
        $products_html = '<div class="col-12"><p class="text-center text-muted">Aucun produit trouvé pour la catégorie homme avec les filtres appliqués.</p></div>';
    } else {
